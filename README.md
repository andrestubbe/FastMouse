# FastMouse 0.1.0 [ALPHA-2026-06-14] — High-Performance Native Mouse API for Java
...
**⚡ A zero-latency native mouse module for the FastJava ecosystem. Real-time mouse movement, button events, and global hooks via JNI.**
...
[![FastMouse Showcase](docs/screenshot.png)](https://www.youtube.com/watch?v=BZsqQl7WqWk)
...
- 🌐 **Global Hooks** — Capture mouse events system-wide with zero latency.
...
1. 📦 **[fastmouse-0.1.0.jar](https://github.com/andrestubbe/FastMouse/releases/download/0.1.0/fastmouse-0.1.0.jar)** (The Core Library)
